<?php
            ...
            $sql="";
            $sql.=" select evolucion.ind,evolucion.factura_consulta,'761470060801' as cod_prestador,if(round((to_days(curdate())-to_days(fecnac))/365.242159)<18,'TI','CC') as tdei,paciente.identificacion,date_format(evolucion.fecha,'%d/%m/%Y') as fecha,evolucion.fecha as fechaj,evolucion.hora as hora,";
			...
			$sql.=" evolucion.diagnostico_relacionado2,evolucion.diagnostico_relacionado3,'2' as tipo_dx,evolucion.valor_consulta,evolucion.valor_copago,evolucion.valor_consulta,'0' as neto";
			$sql.="  from evolucion";
			...
			if (isset($paciente)) $sql.=sprintf(" and paciente.historia='%s'",$paciente);
			$sql.=" group by paciente.historia";
            $sql.=' UNION ';
            $sql.=" select evolucion.ind,evolucion.factura_consulta,'761470060801' as cod_prestador,if(round((to_days(curdate())-to_days(fecnac))/365.242159)<18,'TI','CC'),cppredata.identificacion,date_format(evolucion.fecha,'%d/%m/%Y') as fecha,evolucion.fecha as fechaj,evolucion.hora as hora,";
			$sql.=" '',evolucion.tipoprocedimiento,'10','15',evolucion.diagnostico_principal,evolucion.diagnostico_relacionado1,";
			$sql.=" evolucion.diagnostico_relacionado2,evolucion.diagnostico_relacionado3,'2' as tipo_dx,evolucion.valor_consulta,evolucion.valor_copago,evolucion.valor_consulta,'0'";
			$sql.="  from evolucion";
