<?php
            ...
            $sql="";
			$sql.='select evolucion.factura_consulta,"761470060801" as cod_prestador,paciente.tdei,paciente.identificacion,date_format(evolucion.fecha,"%d/%m/%Y") as fecha,evolucion.fecha as fechaj,evolucion.hora,';
            ...
            $sql.=' UNION ';
            $sql.=' select evolucion.factura_consulta,"761470060801" as cod_prestador,cppredata.tdei,cppredata.identificacion,date_format(evolucion.fecha,"%d/%m/%Y") as fecha,evolucion.fecha as fechaj,evolucion.hora,';
            $sql.='autorizacion_consulta,evolucion.tipoprocedimiento,evolucion.ambito,evolucion.finalidad,personal_que_atiende,evolucion.diagnostico_principal,evolucion.diagnostico_relacionado1,';
